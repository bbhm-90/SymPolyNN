...
def plot_penalty(data_dir:str, figDir:str):
    ...
    ax2 = ax1.twinx()
    ax2.plot(x, loss_pred.loss_pred[1:], c=default_colors[ncolr], linestyle='--')
    ax2.set_xscale("log")
    ax2.set_yscale("log")
    ax2.set_ylabel('MSE level-set prediction', color=default_colors[ncolr])
    ax2.tick_params('y', colors=default_colors[ncolr])
...
if __name__ == "__main__":
    ...
    data_dir = "example/porous_metal/step_1_nn_training/results/Bomarito/baseLO"
